    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.centeredButtonsContainer}>
        <TouchableOpacity style={styles.button}>
          <Image
            source={{
              uri: 'https://img.icons8.com/ios-filled/24/000000/visible.png', // Eye icon
            }}
        ...
        <TouchableOpacity style={styles.button}>
          <Image
            source={{
              uri: 'https://img.icons8.com/ios-filled/24/000000/smartphone.png', // Phone icon
            }}
            style={styles.buttonIcon}
          />
        ...
        <View style={styles.sortFilterContainer}>
          ...
          <View style={styles.sortFilterButtonsContainer}>
            <TouchableOpacity style={styles.button}>
              ...
              <Image
                source={{
                  uri: 'https://img.icons8.com/?size=100&id=izBicqrRIBpp&format=png&color=1A1A1A',
                }}
                style={styles.buttonIcon}
              />
            </TouchableOpacity>
